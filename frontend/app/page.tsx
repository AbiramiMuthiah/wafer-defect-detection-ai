...
// ─── WAFER HEATMAP ────────────────────────────────────────────────────────────
// FIX: inline style colors so Tailwind dynamic classes don't fail
// FIX: renamed to "Wafer Defect Location Map" with plain-English explanation
// FIX: legend uses full descriptions
function WaferHeatmap({ points = [] }: { points: any[] }) {
  const C = 210,
    R = 170;
